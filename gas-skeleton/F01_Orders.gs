...
function pollOrders() {
  try {
    ...
    newOrders.forEach(notifyOrderToDiscord);
...
function notifyOrderToDiscord(o) {
  try {
    ...
    logError('notifyOrderToDiscord failed', { orderId: o.orderId, error: err.message });
  }
}
